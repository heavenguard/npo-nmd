                ...
                await addToSubCollection(
                  {
                    ...
                    type:
                      pendingDonationData.donationType === "donation"
                        ? "Donation"
                          ...
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                {getDonationTypeIcon(
                                  donation.type.toLowerCase().split(" ")[0]
                                )}
                              </div>
                              <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Your lifetime contributions to NMD ASSOCIATION
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
            ...
            <Card className="border-0 shadow-lg bg-white">
              ...
              <CardContent>
                <div className="space-y-4">
                  {!offers.length && memberOffers.length > 0 ? (
                    ...
                    <div className="text-center py-10 px-6 border border-dashed border-gray-300 rounded-xl bg-gray-50">
                      ...
                      <p className="text-gray-600">
                        You currently don’t have any available member offers.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-gray-900">
                      {
                        donations.filter(
                          (donation) => donation.type === "Student Sponsorship"
                        ).length
                      }
                    </span>
                  </div>
