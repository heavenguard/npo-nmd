      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 tracking-tight">{t('hero.title')}</h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">{t('mission.title')}</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('mission.practicalTraining.title')}</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('mission.mission237.title')}</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('mission.continentalImpact.title')}</h3>
                <p className="text-gray-600 leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-800 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-semibold">{t('mission237Highlight.flagshipMission')}</span>
              </div>

              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">{t('mission237Highlight.title')}</h2>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('mission237Highlight.launchWorkshop')}</h4>
                    <p className="text-gray-600">{t('mission237Highlight.launchWorkshopDate')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('mission237Highlight.designWorkshops')}</h4>
                    <p className="text-gray-600">{t('mission237Highlight.designWorkshopsDate')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t('mission237Highlight.launch')}</h4>
                    <p className="text-gray-600">{t('mission237Highlight.launchDate')}</p>
                  </div>
                </div>
              </div>

              <div className="bg-gray-50 p-6 rounded-2xl mb-8">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">{t('mission237Highlight.missionBudget')}</h4>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-blue-600">200,000 EUR</p>
                    <p className="text-sm text-gray-600">{t('mission237Highlight.totalBudget')}</p>
                  </div>
                  <div>
